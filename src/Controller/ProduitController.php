...
#[Route('/fS', name: 'app_produit_indexfS', methods: ['GET'])]
public function indexFilteredS(Request $request, ProduitRepository $produitRepository): Response
{
    // Créer le formulaire de filtrage des prix
    $form = $this->createForm(ProduitSearchType::class);
    $form->handleRequest($request);
    ...
    // Rendre le template avec les produits filtrés ou non
    return $this->render('produit/produitFrontS.html.twig', [
        'produits' => $produits,
        'form' => $form->createView(),
    ]);  
}
